  ...
  return (
    <html lang="en">
      <body className={`${inter.className} bg-gray-50 text-gray-950 relative`}>
        ...
        <div className="bg-[#ffb7b7] darkbg-[#946263] blur-[15rem] fixed -z-10 rounded-full w-[30rem] h-[30rem] md:w-[40rem] md:h-[40rem] md:top-[-8rem] bottom-[-4rem] sm:right-[-8rem] xl:right-[8rem] md:right-[-8rem] right-[-12rem]"></div>
        <Header />
        <MobileMenu />
        {children}
      </body>
