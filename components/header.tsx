...
const Header = () => {
  return (
    <header className="z-[999] relative hidden sm:block">
      <motion.div
        className="hidden sm:flex items-center justify-center fixed top-0 left-1/2 -translate-x-1/2 h-[4.5rem] w-full rounded-none border-2 border-white border-opacity-80 bg-white bg-opacity-40 shadow-lg shadow-black/[0.03] backdrop-blur-[0.5rem] sm:top-6 sm:h-[3.25rem] sm:w-[36rem] sm:rounded-full"
